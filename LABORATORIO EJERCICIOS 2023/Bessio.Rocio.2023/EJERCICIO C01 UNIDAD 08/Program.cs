...
namespace EJERCICIO_C01_UNIDAD_08
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            DirectorTecnico directorTecnico1 = new DirectorTecnico("Almiron",new DateTime(1981,09,12));

            Console.WriteLine($"DIRECTOR TECNICO: {directorTecnico1.MostrarDatos()}");
